...
export default function ClaimableDashboard() {
              ...
              nfts.map((nft, i) => (
                <div key={i} className="border shadow rounded-xl overflow-hidden">
                  ...
                  <div className="p-4 bg-black">
                    ...
                    <button className="w-full bg-pink-500 text-white font-bold py-2 px-12 rounded" onClick={() => paybackNFT(nft)}>Claim NFT</button>
                  </div>
                </div>
              ))
            }
